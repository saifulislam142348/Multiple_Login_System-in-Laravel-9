                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-2">
                                ...
                                <a href="" class="list-group-item text-success"><i class="glyphicon glyphicon-envelope text-primary"></i> all payment Details </a>
                                <a href="" class="list-group-item text-success"><i class="glyphicon glyphicon-envelope text-primary"></i> Teacher</a>
